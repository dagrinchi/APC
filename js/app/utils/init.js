...
define(function(require) {
	...
	var $ = require('jquery'),
		...
		countries = require('app/fixtures/countries'),
	...
	var app = {
		...
		loadDirectorio: function(cb) {
			...
			app.deferred.notify({
				msg: "Descargando datos: Directorio!",
				count: 42.9
			});
		...
		loadDemanda: function(cb) {
			...
			app.deferred.notify({
				msg: "Descargando datos: Proyectos!",
				count: 57.2
			});
